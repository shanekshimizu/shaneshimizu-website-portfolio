...
import { projectfive } from "../constants";
...
const Feedbacks = ({ name }) => {
  ...
  return (
    <div className={`mt-12 bg-zinc-900 rounded-[20px]`}>
      ...
      >
        <div>
          <p className={styles.sectionSubText}>Project Five</p>
          <h2 className={styles.sectionHeadTextTwo}>
            (In Progress) Implementing CI/CD In AWS
          </h2>
        </div>
      </div>
      <div
      ...
      >
        ...
        >
          <div className="relative w-full h-[830px]">
            ...
            {/*original 430*/}
            <img
              src={projectfive[0].image} //change the image for the project cards
              alt="project_image"
              className="w-full h-full object-contain rounded-2xl"
            />
            <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
